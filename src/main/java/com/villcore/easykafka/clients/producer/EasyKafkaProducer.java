...
public interface EasyKafkaProducer<K, V> {
    ...
    SendResult sendSync(String topic, int partition, K key, V value);
    ...
    SendResult sendSync(String topic, int partition, K key, V value, Map<String, Object> header);
    ...
    Future<SendResult> sendAsync(String topic, int partition, K key, V value, SendCallback sendCallback);
    ...
    Future<SendResult> sendAsync(String topic, int partition, K key, V value, Map<String, Object> header, SendCallback sendCallback);
